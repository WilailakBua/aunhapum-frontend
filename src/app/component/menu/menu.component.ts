...
export class MenuComponent {
    dataMenu = [
        ...
        { "id": 29	, "name": "ปังปิ้งราดนมหรือช็อก+ผงโอวัลติน+อัลมอนด์สไลด์", "price": 30	},
        { "id": 30	, "name": "ปังปิ้งราดนมหรือช็อก+โอวัลตินเฟลค+ลูกเกด ", "price": 30	},
        // { "id": 31	, "name": "ปังปิ้งราดนมหรือช็อก+โกโก้ครั้น+คอปปสกาย ", "price": 30	},
        { "id": 32	, "name": "ปังปิ้งราดนมหรือช็อก+โอวัลตินเฟลค+โกโก้ ครั้น", "price": 30	},
        ...
        { "id": 36	, "name": "ปังปิ้งราดนมหรือช็อก+โอวัลตินเฟลค+อัลมอนด์สไลด์", "price": 30	},
        ...
        { "id": 41	, "name": "ปังปิ้งราดนมหรือช็อก+ผงโอวัลติน+มาร์ชเมลโล่ขาวใหญ่", "price": 35	},
        { "id": 42	, "name": "ปังปิ้งราดนมหรือช็อก+คอนเฟลค+มาร์ชเมลโล่ขาวใหญ่", "price": 40	},
        { "id": 43	, "name": "ปังปิ้งราดนมหรือช็อก+โอวัลติน เฟลค+มาร์ชเมลโล่ขาวใหญ่", "price": 40	},
        ...
        { "id": 50	, "name": "ปังปิ้งมาร์ชเมลโล่ขาวใหญ่ราดซอสสตรอว์เบอร์รี่", "price": 35	},
